...
def df_create_and_merge():
    ...
    df.rename(columns={"b'Date Submitted'": 'Date_Submitted', "b'Date/Timeof Event'": 'Date_Time', "b'Location of Event'": 'Location', "b'Short Description'": 'Short_Description'}, inplace=True)
